...
p=Path('backend/test-output/industry50-stack/96f25e6a865f/receipt.json')
...
old=inspect(name)
assert name=='nis-e2e-app-96f25e6a865f' and old['Config']['Labels']['networkis.test']=='disposable'
...
Path('.tool-checker/industry50-ai-preflight.json').write_text(json.dumps({'models':models,'test_container':name,'base_url':r['base_url'],'image_id':r['image_id']},indent=2),encoding='utf-8')
