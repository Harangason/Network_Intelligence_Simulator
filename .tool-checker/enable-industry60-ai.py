...
p=Path('backend/test-output/industry60-stack/f4a32bef96e8/receipt.json')
...
old=inspect(name)
assert name=='nis-e2e-app-f4a32bef96e8' and old['Config']['Labels']['networkis.test']=='disposable'
...
Path('.tool-checker/industry60-ai-preflight.json').write_text(json.dumps({'models':models,'test_container':name,'base_url':r['base_url'],'image_id':r['image_id']},indent=2),encoding='utf-8')
