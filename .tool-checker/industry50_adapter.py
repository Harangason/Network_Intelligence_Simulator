...
def main():
    ...
    assert base=='http://127.0.0.1:60023' and project.startswith('nis-e2e-industry50-')
    folder=root/'.tool-checker/evidence/industry50'/case['test_id'];folder.mkdir(parents=True,exist_ok=True)
    evidence=[]
