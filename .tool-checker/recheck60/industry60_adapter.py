...
def main():
    ...
    assert base=='http://127.0.0.1:49546' and project.startswith('nis-e2e-industry60-')
    folder=root/'.tool-checker/evidence/industry60-recheck'/case['test_id'];folder.mkdir(parents=True,exist_ok=True)
    evidence=[]
