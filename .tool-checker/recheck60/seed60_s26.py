...
from industry60_fixtures import api,seed,ROOT
p='nis-e2e-industry60-s26';d=seed(p)
...
(ROOT/'.tool-checker/evidence/industry60-recheck/S26/fixture-extension.json').write_text(json.dumps({'two_CAN_networks':params['networks'],'two_payloads':[d['message']['id'],msg['id']],'prompt_binding':'Existing function=ParkAssist; target function on ADAS_Controller=DriverAssistance; no choice auto-answered'},indent=2),encoding='utf8')
