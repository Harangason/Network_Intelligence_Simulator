...
OUT=ROOT/'.tool-checker/evidence/industry60/trace'
BASE='http://127.0.0.1:51576';PROJECT='nis-e2e-industry60-trace'
jobs={}
...
(OUT/'jobs.json').write_text(json.dumps({'project':PROJECT,'base':BASE,'jobs':jobs,'scope':'HTTP simulation jobs from reviewed explicit config; no canonical workflow snapshot fabricated'}),encoding='utf8')
