...
(ROOT/'.tool-checker/evidence/industry60/S26/fixture-extension.json').write_text(json.dumps({'two_CAN_networks':params['networks'],'two_payloads':[d['message']['id'],msg['id']],'prompt_binding':'Existing function=ParkAssist; target function on ADAS_Controller=DriverAssistance; no choice auto-answered'},indent=2),encoding='utf8')
