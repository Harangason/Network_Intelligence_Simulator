...
from ..states import StateMachineEngine, controller_profile
from .generic import health, operating, quality, safety, status_dimension


def controller_status(signal: Any, time_s: float, context: Any, state: Any) -> float:
    ...
    return operating(signal, time_s, context, state, StateMachineEngine(controller_profile()))
