...
import { applyConfirmedClusterGraph, extractEngineeringSpecification, expandEngineeringSignalModel, packEngineeringChains } from '../src/lib/agent/engineering-specification.ts';
...
specification.chains = packEngineeringChains(expandEngineeringSignalModel(applyConfirmedClusterGraph(specification.chains, prompt)));
