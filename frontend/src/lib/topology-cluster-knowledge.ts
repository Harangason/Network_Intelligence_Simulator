...
const AUTOMOTIVE_RULES: TopologyClusterRule[] = [
  ...
  { key: "climate", label: "Klima / Thermik", role: "actuation", terms: ["klima", "climate", "hvac", "thermal", "kuehlung", "kuehl", "kuehlkreislauf", "cooling", "coolant", "thermo", "compressor", "kompressor", "ambient", "aussen", "outside", "cabin", "innenraum", "refrigerant", "kaeltemittel"], related: ["energy", "body_comfort", "emobility"] },
