...
def _runtime_environment() -> dict[str, str]:
    ...
    environment.setdefault("OLLAMA_FAST_KEEP_ALIVE", _config_text(resources, "ollama_fast_keep_alive", "30m"))
    environment.setdefault("NUMERIC_ACCELERATOR", _config_text(resources, "numeric_accelerator", "auto"))
    environment.setdefault("NUMERIC_ACCELERATOR_MIN_ITEMS", str(_config_int(resources, "numeric_accelerator_min_items", 256)))
