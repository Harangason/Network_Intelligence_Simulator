...
assert script in {'verify_communication_repair_sql.py','verify_function_architecture_sql.py', 'verify_assistant_sql.py', 'verify_routing_scope_sql.py', 'verify_goal_execution_sql.py', 'verify_project_refresh_sql.py'}
